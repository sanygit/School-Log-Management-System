			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_employee">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$employee = $conn->query("SELECT * FROM employees  order by name asc ");
...
<script>
	...
	$('.edit_employee').click(function(){
		uni_modal("Manage Employee Details","manage_employee.php?id="+$(this).attr('data-id'),"mid-large")
